# NEOPapaya Nano Roadmap

Este documento describe la hoja de ruta para la evolución del proyecto NEOPapaya Nano.
...
- [X] **Refactorización Core**: Modularización de `NeoCore.py`, `voice_manager.py`, `intent_manager.py`.
